    ...
    <div class="d-block d-sm-none  offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
      ...
      <div class="offcanvas-body ">
        ...
        @guest
          ...
          @else
            <div class="col">
                <img src="{{asset('storage/'.Auth::user()->image )}}" width="30" class="user-image" height="30" class=" " alt="" srcset="">
                <div class="user-name">
                 {{ Auth::user()->name }} {{ Auth::user()->lastName }}
               </div>
                <ul class="list-group list-group-flush">
                    @if (Auth::user()->isArtisan)
                    <li class="list-group-item"><a class="dropdown-item" href="{{route('my_annonce')}}"><i class="fa fa-rectangle-ad mr-5"> </i>  Mes Annonces</a></li>
                    @else
                    <li class="list-group-item"><a class="dropdown-item" href="{{ route('to_artisan') }}"
                      onclick="event.preventDefault();
                                    document.getElementById('to_artisan').submit();"><i class="fa-solid fa-repeat"></i>
                        {{ __('devenir un bricoleur') }}
                    </a></li>
                    @endif
                    <li class="list-group-item"> <a class="dropdown-item" href="{{route('messages')}}"><i class="fa-solid fa-message"> </i> Messages</a></li>
                    <li class="list-group-item"><a class="dropdown-item" href="{{route('dashbord')}}"><i class="fa fa-gear"> </i>  Parameter</a></li>
      ...
      <ul class="navbar-nav ms-auto">
        <!-- Authentication Links -->
           @guest
            ...
            <a class="btn btn-primary ms-2 rounded border " href="/register">INSCRIPTION</a>
            @endguest
            @auth
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu " aria-labelledby="navbarDropdown">
                    @if (Auth::user()->isArtisan)
                    <a class="dropdown-item" href="{{route('my_annonce')}}"><i class="fa fa-rectangle-ad mr-5"> </i> Mes Annonces</a>
                    @else
                    ...
                    @endif
                    <a class="dropdown-item" href="{{route("messages")}}"><i class="fa-solid fa-message"></i> Messages</a>
                    <a class="dropdown-item" href="{{route("dashbord")}}"><i class="fa fa-gear"> </i>  Dashbord</a>
