...
@section('content')
    ...
    <div class="container d-none  d-lg-block  ">
        <section class=" bannier d-flex align-items-start flex-column">
          <h1 class="ms-4 text-uppercase">bienvenue chez</h1>
          <h1 class="ms-4 text-uppercase">HIRFATI</h1>
        </section>
    </div> 
    {{-- end banniére  --}}
    {{-- start search  --}}
             ...
             <div class="zone-search text-center shadow-sm p-3 rounded">
                 <div class="row ">
                     <div class=" col d-none d-sm-block ">
                         <div class="input-container">
                             ...
                             <input type="search" class="form-control" name="searchtext"  placeholder="Que Recherche vous ?">
                         </div>
                     </div>
                     <div class="col ">
                         <div class="input-container">
                             <i class="prefix fa fa-filter"></i> 
                             <select name="category" class="form-select " id="select_category" name="category" data-live-search="true" data-live-search-style="startsWith">
                     ...
                     <div class="col">
                         <div class="input-container">
                             ...
                             <select name="location" class="form-select" id="select-country" name="location" style="align-items: center ; text-align: left;" >
                 ...
                 <div class="row mt-3">
                     <div class="col text-center ">
                         <button type="submit" class="px-10 btn btn-primary" >RECHERCHE  </button>
                     </div>
                 </div>
             </div>
        </form>
    </div>
    {{-- <livewire:search-componenet :categories="$categories" /> --}}
    {{-- end  search  --}}
