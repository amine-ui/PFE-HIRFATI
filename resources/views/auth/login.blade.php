           ...
           <div class="col-md-6 right-box">
              <div class="row align-items-center">
                        ...
                        <div class="input-group mb-3">
                            <a href="{{route('login.google')}}" class="btn btn-lg btn-light w-100 fs-6"><img src="{{asset('assets/images/google.png')}}" style="width:20px" class="me-2"><small>Se connecter avec Google</small></a>
                        </div>
                        <div class="row">
